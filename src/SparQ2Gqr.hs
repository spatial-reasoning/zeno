...
_PROGRAM_ABOUT = "converts constraint networks from SparQ to GQR format and vice versa"
...
exec opts@MyOptions{..} = do
    network <- loadSparqNetworkFile infilename
    exportToGqr network outfilename
